...
int LED1 = 26,LED2 = 22,SW1=14;
int *pLED1 = &LED1 ,*pLED2 = &LED2 , *pSW1 = &SW1 ;


#define long_press_repeat_time 0.01
...
//    //delay(1000);
    ...
    lv_obj_add_event_cb(objects.onmotor_bt , event_handler , LV_EVENT_CLICKED , pLED1);
    lv_obj_add_event_cb(objects.offmotor_bt , event_handler , LV_EVENT_CLICKED , pLED1);
    lv_obj_add_event_cb(objects.incrementpwm , event_handler ,LV_EVENT_LONG_PRESSED_REPEAT , NULL);
    lv_obj_add_event_cb(objects.decrementpwm , event_handler ,LV_EVENT_LONG_PRESSED_REPEAT , NULL);
    lv_obj_add_event_cb(objects.onpwm_sw , event_handler , LV_EVENT_VALUE_CHANGED ,pLED2 );

    plotchart();
    lv_timer_create(updatechart_adc , 100 , NULL);
    lv_timer_create(readsw , 200 , pSW1);
